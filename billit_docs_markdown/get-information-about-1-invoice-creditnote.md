---
title: "Get Information About 1 Invoice/CreditNote"
updated: 2026-05-26
source_url: "https://docs.billit.be/docs/get-information-about-one-invoicecreditnote"
source_slug: "get-information-about-one-invoicecreditnote"
...
- API + UBL:
  - Files :
    - Extract PDF for displaying in your software
    - Extract XML file coming from Peppol and parse the content of the XML/UBL file. You are now processing the native Peppol UBL file.
...
| CompanyID | UniqueID | Company Owner ID of the invoice in Billit system |
...
| Attachments | List<Object> | Contains the optional additional Attachments. |
...
```json
{
    ...
    "Attachments": [ //1 or more attachments (Excel, PDF, XML, ...).  There will be only one XML : it is the UBL file.\
        {\
