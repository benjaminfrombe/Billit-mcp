---
title: "Billit API Source Docs - Retrieve List Of Invoices"
updated: 2026-05-26
---
...
We allow Odata queries to be ran on top of the endpoint giving you more freedom to already provide us some queries which will filter the response. More info about Odata can be found here -> [Odata Info](https://docs.billit.be/docs/odata)
...
Below results of the first document of the list:
